                        ...
                        <form role="form" name="guardar-registro" id="guardar-registro" method="post" action="modelo-evento.php">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="titulo_evento" name="titulo_evento" placeholder="Introduce el nombre del evento">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="hora_evento" class="form-control hora_evento">
